<?php include "hheader.php"; ?>
    <section id="about">
                    ...
                    <div class="container">
                        <center><h3>Welcome to KID'sCARE</h3></center>     
                        </section>
            <!---------slider-------->
    <div id="slider">
